...
import application.busqueda.DestinatarioContiene;
import application.model.Mensaje;
import application.model.Individuo;

/**
 * Pruebas unitarias de la clase {@link DestinatarioContiene}
 * 
 * @author Alberto Rodríguez Peón
 * 
 */
public class DestinatarioContieneTest {
	...
	public void setUp() throws Exception {
		cb = new DestinatarioContiene("101");
	...
	/**
	 * Test method for
	 * {@link application.busqueda.DestinatarioContiene#seleccionarMensajes(java.util.List)}
	 * .
	 */
	@Test
