...
import application.busqueda.EmisorNoContiene;
import application.model.Mensaje;
import application.model.Individuo;

/**
 * Pruebas unitarias de la clase {@link EmisorNoContiene}
 * 
 * @author Alberto Rodríguez Peón
 * 
 */
public class EmisorNoContieneTest {
	...
	/**
	 * Test method for
	 * {@link EmisorNoContiene#seleccionarMensajes(java.util.List)}.
	 */
	@Test
	public void testSeleccionarMensajes() {
		List<Mensaje> resultado = cb.seleccionarMensajes(mensajes);
		assertEquals(resultado.size(), 1);
		assertEquals(resultado.get(0).getEmisor(), new Individuo("401"));
	}
