...
import application.busqueda.GruposNoContiene;
import application.model.Grupo;
import application.model.Mensaje;
import application.model.Individuo;

/**
 * Pruebas unitarias de la clase {@link GruposNoContiene}
 * 
 * @author Alberto Rodríguez Peón
 * 
 */
public class GruposNoContieneTest {
	...
	/**
	 * Test method for
	 * {@link GruposNoContiene#seleccionarMensajes(java.util.List)}.
	 */
	@Test
