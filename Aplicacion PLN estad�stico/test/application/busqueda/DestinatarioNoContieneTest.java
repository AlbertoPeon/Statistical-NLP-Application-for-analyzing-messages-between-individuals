...
import application.busqueda.DestinatarioNoContiene;
import application.model.Mensaje;
import application.model.Individuo;

/**
 * Pruebas unitarias de la clase {@link DestinatarioNoContiene}
 * 
 * @author Alberto Rodríguez Peón
 * 
 */
public class DestinatarioNoContieneTest {
	...
	public void setUp() throws Exception {
		cb = new DestinatarioNoContiene("101");
	...
	/**
	 * Test method for
	 * {@link application.busqueda.DestinatarioNoContiene#seleccionarMensajes(java.util.List)}
	 * .
	 */
	@Test
	public void testSeleccionarMensajes() {
		...
		assertEquals(resultado.get(0).getReceptor(), new Individuo("401"));
	}
